...
export default function Die({ value, sides, code }: { value: number; sides: number; code: 'w' | 'd' }) {
  ...
  const tooltip = Number.isFinite(sides) ? `${code.toUpperCase()}${sides}: ${value}` : String(value);
  return (
