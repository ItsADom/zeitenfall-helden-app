...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    added: [
      ...
      'Am virtuellen Tisch gibt es jetzt eigene Rundenzähler, z. B. für die Dauer eines Zaubers — beliebig viele, mit Label und Startwert, ±1 jederzeit von Hand, automatisch −1 bei jedem Rundenwechsel. Rein persönlich: nur ihr selbst seht eure eigenen Zähler, niemand sonst am Tisch.',
      'Charakter-Marken am virtuellen Tisch können jetzt leichte und schwere Wunden führen (eigene Hausregel, getrennt von den Lebenspunkten) — ±1 von Hand direkt an der Marke, als kleines Abzeichen sichtbar. Rein privat: nur die Besitzerin der Marke und die Spielleitung sehen die Zählung, niemand sonst am Tisch.',
      'Bemalen, Hervorheben und Nebel haben am virtuellen Tisch jetzt zwei zusätzliche Pinselarten neben dem gewohnten Einzelfeld: „Rechteck" zieht eine Fläche auf einmal auf, „Füllen" färbt mit einem Klick den ganzen zusammenhängenden Bereich (wie ein Fülleimer-Werkzeug) — beide über den kleinen Schalter oben im jeweiligen Werkzeug-Menü.',
      'Marken (Marker/Monster) am virtuellen Tisch zeigen jetzt ihre Besitzerin im Marken-Editor an und lassen sich dort umverteilen — die Spielleitung oder die aktuelle Besitzerin kann eine Marke jederzeit einer anderen Person geben oder wieder freigeben. Charakter-Marken sind davon nicht betroffen: ihre Besitzerin bleibt immer, wer den Charakter spielt.',
    ],
    changed: [
