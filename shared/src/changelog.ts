...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    added: [
      ...
      'Baugleiche Nah-/Fernkampfwaffen (z. B. mehrere Wurfmesser) fassen sich im Waffen-Reiter jetzt zu einer Stapel-Karte mit „×N“ zusammen, aufklappbar zu den einzelnen Exemplaren mit ihrer je eigenen Haltbarkeit.',
    ],
    admin: [
  ...
  },
  {
    ...
    changes: [
      ...
      'Farbthemen: über das Menü oben rechts das Aussehen umstellen, z. B. Khôm (Rot), Bornland (Grün), Thorwal (Blau), Drachensteine (Amethyst), Gareth (Bronze) und Schattenlande (Nachtmodus). Die Wahl bleibt pro Gerät gespeichert.',
